    ...
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 py-1 px-4 flex items-end">
        <div className="w-full flex items-center space-x-3">
          ...
          <span className="text-white text-4xl font-genuine pt-2.5 text-bg-blur-xl">{index}</span>
          <span className="text-white text-2xl font-bold text-bg-blur-xl">{title}</span>
        </div>
      </div>
    </div>
  );
